...
python -m pip install computerworld==0.1.1
...
[v0.1.1](https://github.com/JacobFV/computerworld/releases/tag/v0.1.1) with a
...
python -m pip install --force-reinstall target/wheels/computerworld-0.1.1-*.whl
python -c "import computerworld; print(computerworld.__version__, computerworld.engine_version)"
# Expected: 0.1.1 0.1.1
```
