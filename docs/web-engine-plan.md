...
`research/dom-to-site.md` §1 is the full list. Authoring the sites as Rust element trees
...
engine can now render nearly as captured. `research/dom-to-site.md` §5 lists the losses;
