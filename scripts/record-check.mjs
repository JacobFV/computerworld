 ...
 *
 *   The search      `scripts/cw-check.mjs --depth 2 --progress 1` is run as a child
...
const usage = `Record the bounded check: the search, the verdict, the replay.
  ...
  node scripts/record-check.mjs [options]
...
async function runChecker() {
  ...
  const child = spawn(process.execPath, [
    `${root}scripts/cw-check.mjs`, '--depth', String(options.depth), '--progress', '1', '--out', reportPath,
