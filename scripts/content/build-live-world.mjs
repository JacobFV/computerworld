 ...
 * result to site/generated/world-definition.js, which site/live.js downloads as text and each of
 * its workers parses for itself. OS shells are rendered by Rust, never HTML overlays.
 *
 *   node scripts/content/build-live-world.mjs      # or scripts/build-content.sh, which runs it
 */
...
// the engines themselves (crates/engines/sheet/tests/samples.rs, crates/engines/sql/tests/samples.rs)
...
// the sample clips and sounds the engine generates (crates/engines/video/tests/samples.rs):
...
// and ~/bin come from each machine's root/ under worlds/company-2026/computers, seeded into
// world.json when worlds/company-2026/world.yml is built; nothing is added here.
await writeFile(new URL('../../site/generated/world-definition.js',import.meta.url),`// Generated by node scripts/content/build-live-world.mjs\nexport default ${JSON.stringify(definition,null,2)};\n`);
