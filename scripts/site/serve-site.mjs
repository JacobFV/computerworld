 ...
 *
 *   node scripts/site/serve-site.mjs [port]
 */
...
createServer(async (request, response) => {
  try {
    ...
    response.end('Not found. Build the machines first: bash scripts/build-wasm.sh && node scripts/content/build-live-world.mjs\n');
  }
