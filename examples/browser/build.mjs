...
definition.metadata={...definition.metadata,desktop_apps:[{id:'mail',label:'Mail',kind:'browser',url:'http://mail.internal/',icon:'mail'},{id:'calendar',label:'Calendar',kind:'browser',url:'http://calendar.internal/',icon:'calendar'},{id:'chat',label:'Messages',kind:'browser',url:'http://chat.internal/',icon:'chat'},{id:'docs',label:'Documents',kind:'browser',url:'http://docs.internal/',icon:'docs'}],device_presentations:{'alice-mac':'desktop','bob-windows':'desktop','carol-ubuntu':'laptop','app-server':'server','git-server':'server','alice-phone':'phone','bob-android':'phone'}};
for(const computer of definition.computers){if(computer.profile.startsWith('virtual-'))computer.installed_apps.push('mail','calendar','chat','docs');}
