...
for(const computer of definition.computers){if(computer.profile.startsWith('virtual-'))computer.installed_apps.push(...nativeApps.map(a=>a.id));}
...
for(const computer of definition.computers){computer.installed_apps.push(...(imageEditors[computer.profile]||[]));}
