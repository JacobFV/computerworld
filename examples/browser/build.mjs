...
console.log(`Built embedded OS desktop world (7 devices, 5 graphical OS profiles, ${definition.services.length} services, ${nativeApps.length+editorApps.length+officeApps.length} native applications).`);
