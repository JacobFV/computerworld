...
// scripts/build-home.mjs; nothing is added here.
...
console.log(`Built embedded OS desktop world (7 devices, 5 graphical OS profiles, ${definition.services.length} services, ${nativeApps.length+editorApps.length+officeApps.length+videoApps.length} native applications).`);
