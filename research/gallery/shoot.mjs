...
//
//   PLAYWRIGHT_MODULE=... CHROME_BIN=... node research/gallery/shoot.mjs <label> [--url http://localhost:8123/]
//
// Writes research/gallery/<label>-{desk-rest,desk-moving,desk-next,phone-rest,phone-moving}.png
