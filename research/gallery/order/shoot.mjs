...
//
//   PLAYWRIGHT_MODULE=... CHROME_BIN=... node research/gallery/order/shoot.mjs [label]
//     [--url http://127.0.0.1:8123/] [--live] [--reduced] [--flat] [--turn] [--no-posters]
//     [--size desk] [--scene <id> ...]
//
// Writes research/gallery/order/<label>-<width>-<scene>.png. Without --live the simulator
