...
commands! {
    ...
    ("workbench.action.splitEditorRight", "View: Split Editor Right", "Split Right", "Ctrl+\\"),
    ("workbench.action.splitEditorDown", "View: Split Editor Down", "Split Down", "Ctrl+K Ctrl+\\"),
    ("workbench.action.moveEditorToNextGroup", "View: Move Editor into Next Group", "Move Editor into Next Group", "Ctrl+Alt+Right"),
    ("workbench.action.moveEditorToPreviousGroup", "View: Move Editor into Previous Group", "Move Editor into Previous Group", "Ctrl+Alt+Left"),
    ("workbench.action.focusNextGroup", "View: Focus Next Editor Group", "Focus Next Group", ""),
    ("workbench.action.focusPreviousGroup", "View: Focus Previous Editor Group", "Focus Previous Group", ""),
    ("workbench.action.focusFirstEditorGroup", "View: Focus First Editor Group", "Focus First Group", "Ctrl+1"),
    ("workbench.action.focusSecondEditorGroup", "View: Focus Second Editor Group", "Focus Second Group", "Ctrl+2"),
    ("workbench.action.focusThirdEditorGroup", "View: Focus Third Editor Group", "Focus Third Group", "Ctrl+3"),
    ...
    ("editor.action.addSelectionToNextFindMatch", "Add Selection To Next Find Match", "Add Next Occurrence", "Ctrl+D"),
    ("editor.action.selectHighlights", "Select All Occurrences of Find Match", "Select All Occurrences", "Ctrl+Shift+L"),
    ("editor.action.insertCursorAbove", "Add Cursor Above", "Add Cursor Above", "Ctrl+Alt+Up"),
    ("editor.action.insertCursorBelow", "Add Cursor Below", "Add Cursor Below", "Ctrl+Alt+Down"),
    ("removeSecondaryCursors", "Remove Secondary Cursors", "Remove Secondary Cursors", ""),
    ...
    ("editor.action.toggleRenderWhitespace", "View: Toggle Render Whitespace", "Render Whitespace", ""),
    ...
    ("workbench.action.debug.continue", "Debug: Continue", "Continue", "F5"),
    ("workbench.action.debug.pause", "Debug: Pause", "Pause", "F6"),
    ("workbench.action.debug.stepOver", "Debug: Step Over", "Step Over", "F10"),
    ("workbench.action.debug.stepInto", "Debug: Step Into", "Step Into", "F11"),
    ("workbench.action.debug.stepOut", "Debug: Step Out", "Step Out", "Shift+F11"),
    ("workbench.action.debug.restart", "Debug: Restart", "Restart", "Ctrl+Shift+F5"),
    ("workbench.action.debug.stop", "Debug: Stop", "Stop", "Shift+F5"),
    ("editor.debug.action.toggleBreakpoint", "Debug: Toggle Breakpoint", "Toggle Breakpoint", "F9"),
    ("editor.debug.action.conditionalBreakpoint", "Debug: Add Conditional Breakpoint", "Add Conditional Breakpoint", ""),
    ("workbench.debug.viewlet.action.removeAllBreakpoints", "Debug: Remove All Breakpoints", "Remove All Breakpoints", ""),
    ("workbench.debug.viewlet.action.addWatchExpression", "Debug: Add Watch Expression", "Add Watch", ""),
    ("workbench.debug.viewlet.action.removeAllWatchExpressions", "Debug: Remove All Watch Expressions", "Remove All Watches", ""),
    ("workbench.debug.action.toggleRepl", "View: Debug Console", "Debug Console", "Ctrl+Shift+Y"),
    ("debug.addConfiguration", "Debug: Add Configuration", "create a launch.json file", ""),
    ...
    ("copyFilePath", "File: Copy Path of Active File", "Copy Path", "Ctrl+K Ctrl+C"),
    ("revealFileInOS", "File: Reveal in File Explorer", "Reveal in File Manager", "Ctrl+K R"),
    ("openInIntegratedTerminal", "File: Open in Integrated Terminal", "Open in Integrated Terminal", ""),
    ("editor.action.revealDefinition", "Go to Definition", "Go to Definition", "F12"),
