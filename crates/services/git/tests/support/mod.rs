...
impl Page {
    ...
    pub fn has_class(&self, id: &str, class: &str) -> bool {
        self.doc
            .attr(self.node(id), "class")
            .is_some_and(|c| c.split_ascii_whitespace().any(|k| k == class))
    }
