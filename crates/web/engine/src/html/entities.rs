...
//! <https://html.spec.whatwg.org/entities.json> (SHA-256 d741d877ac77c4194c4ad526b5b4a19aef8dfe411ab840a466891cdbb9f362e6).
//! Do not edit by hand; rerun the script.
//!
//! 2231 names, 106 of them without a trailing semicolon,
//! sorted by name (byte order) so `lookup` can binary-search.

/// Number of names in the table.
pub const COUNT: usize = 2231;
