...
//! layer. Each fixture under `crates/web/engine/tests/script/` loads its vendored bundle
//! from `crates/web/engine/tests/vendor/` (see `tools/fetch-vendor.sh`), runs to idle and is
...
fn svelte4_compiled_components_run_stores_events_and_transitions() {
    // `crates/web/engine/tools/build-svelte.mjs` compiles `tests/script/svelte/*.svelte` with
