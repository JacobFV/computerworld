...
# (crates/web/engine/tests/vendor/), verifying each file's SHA-256. Re-run after bumping
...
# Tailwind isn't a static bundle: it's generated from crates/web/engine/tools/tailwind/
...
# Svelte isn't a static bundle either: `crates/web/engine/tests/script/svelte/Todos.svelte`
